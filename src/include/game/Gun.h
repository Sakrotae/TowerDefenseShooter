...
struct Bullet
{
     ...
     */
    constexpr static double LIFETIME = 2.5;

    /**
     * Velocity of a bullet
     */
    constexpr static int VELOCITY = 50;

    /**
     * Color of a bullet
     */
    constexpr static glm::vec4 COLOR{2.95, 0.25, 0.25, 1.0};

    /**
     * Form of a bullet
     */
    constexpr static glm::vec3 SCALE{0.02, 0.02, 0.12};
...
private:
     ...
     */
    constexpr static double shootDelay = 0.3;
