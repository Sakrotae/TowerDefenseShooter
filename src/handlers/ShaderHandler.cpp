...
unsigned int loadShader(const char *path, const int &shaderType)
{
    ...
    if (!success)
    {
        ...
        std::cout << "WARNING! Loading shaders failed!" << std::endl
                  << infoLog << std::endl;
    }
    return shaderID;
}
 ...
 */
unsigned int loadProgram(const char *fragmentPath, const char *vertexPath)
{
    ...
    if (!success)
    {
        ...
        std::cout << "WARNING! Linking shaders failed!" << std::endl
                  << infoLog << std::endl;
    }
...
{
    shader = loadProgram("rsc/shaders/SimpleFragmentShader.fragmentshader", "rsc/shaders/SimpleVertexShader.vertexshader");
}
